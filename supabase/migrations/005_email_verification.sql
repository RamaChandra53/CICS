...
-- Consolidated from: college-email-verification.sql,
--   soft-verification-model.sql
-- ============================================================
...
-- Update existing profiles to ensure is_email_verified is set
UPDATE profiles
...
COMMENT ON COLUMN profiles.is_email_verified IS
  'Whether the user verified their MGIT college email via OTP.';
